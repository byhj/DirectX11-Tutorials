...
bool BitmapClass::Init(ID3D11Device *pD3D11Device, int ScreenWidth , int ScreenHeight, WCHAR *textureFile, int BitmapWidth, int BitmapHeight)
{
	bool result;
...
bool BitmapClass::Render(ID3D11DeviceContext *pD3D11DeviceContext, int posX, int posY)
{
	bool result;
...
bool BitmapClass::InitBuffer(ID3D11Device *pD3D11Device)
{
	Vertex *VertexData;
...
bool BitmapClass::UpdateBuffer(ID3D11DeviceContext* pD3D11DeviceContext, int posX, int posY)
{
...
void BitmapClass::RenderBuffer(ID3D11DeviceContext *pD3D11DeviceContext)
{
	unsigned int stride;
	unsigned int offset;
...
bool BitmapClass::LoadTexture(ID3D11Device *pD3D11Device, WCHAR *textureFile)
{
	bool result;
...
void BitmapClass::ShutdownTexture()
{
	if (pTexture)
	{
		pTexture->Shutdown();
