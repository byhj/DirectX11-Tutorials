...
bool TextureClass::Init(ID3D11Device *pD3D11Device, WCHAR *textureFile1, WCHAR *textureFile2, WCHAR *textureFile3)
{
	HRESULT result;
	...
	result = D3DX11CreateShaderResourceViewFromFile(pD3D11Device, textureFile3, NULL, NULL, &pTextures[2], NULL);
	if ( FAILED(result) )
	{
		return false;
	}
