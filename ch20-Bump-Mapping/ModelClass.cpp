...
bool ModelClass::Init(ID3D11Device *pD3D11Device, char *modelFile, WCHAR *textureFile1, WCHAR *textureFile2)
{
	bool result;
	...
	//Load Texture file
	result = LoadTextures(pD3D11Device, textureFile1, textureFile2);
	if (!result)
	{
		return false;
	}
...
bool ModelClass::LoadTextures(ID3D11Device*pD3D11Device, WCHAR *textureFile1, WCHAR *textureFile2)
{
	bool result;
	...
	result = pTexture->Init(pD3D11Device, textureFile1, textureFile2);
	if (!result)
	{
		return false;
	}
