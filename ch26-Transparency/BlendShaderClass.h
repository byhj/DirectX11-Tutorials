...
class  BlendShaderClass
{
public:
	 BlendShaderClass();
	 BlendShaderClass(const BlendShaderClass &);
	~ BlendShaderClass();

	bool Init(ID3D11Device *, HWND);
	void Shutdown();
	bool Render(ID3D11DeviceContext*, int, D3DXMATRIX, D3DXMATRIX, D3DXMATRIX, 
		        ID3D11ShaderResourceView**, D3DXVECTOR3, D3DXVECTOR4, D3DXVECTOR3, D3DXVECTOR4, float, float);
