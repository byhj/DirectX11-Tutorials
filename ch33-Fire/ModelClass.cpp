...
bool ModelClass::Init(ID3D11Device *pD3D11Device,WCHAR* textureFilename1, WCHAR* textureFilename2, 
					  WCHAR* textureFilename3, char *modelFile)
{
	bool result;
	...
	//Load Texture file
	result =  LoadTexture(pD3D11Device, textureFilename1, textureFilename2, textureFilename3);
	if (!result)
	{
		return false;
	}
...
bool ModelClass::LoadTexture(ID3D11Device*pD3D11Device, WCHAR* textureFilename1, WCHAR* textureFilename2, WCHAR* textureFilename3)
{
	bool result;
	...
	result = m_Texture1->Init(pD3D11Device, textureFilename1);
	if(!result)
	{
		return false;
	}
	...
	// Initialize the texture object.
	result = m_Texture2->Init(pD3D11Device, textureFilename2);
	if(!result)
	{
		return false;
	}
	...
	// Initialize the texture object.
	result = m_Texture3->Init(pD3D11Device, textureFilename3);
	if(!result)
	{
		return false;
	}
