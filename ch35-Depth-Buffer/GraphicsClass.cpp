...
bool GraphicsClass::Init(int screenWidth, int screenHeight, HWND hWnd)
{
	...
	result = pModel->Init(pD3D->GetDevice(), L"../common/media/texture/seafloor.dds", "floor.txt");
