...
bool Cube::init_buffer(ID3D11Device *pD3D11Device, ID3D11DeviceContext *pD3D11DeviceContext)
{
	...
	dataPtr2->ambientColor   = D3DXVECTOR4(0.85f, 0.85f, 0.85f, 0.15f);
	...
	DebugHR(hr);
	hr = D3DX11CreateShaderResourceViewFromFile(pD3D11Device, L"../../media/textures/light01.dds", NULL,NULL, &m_pTextures[1], NULL);
	DebugHR(hr);
