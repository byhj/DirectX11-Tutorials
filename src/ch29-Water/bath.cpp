...
void Bath::Render(ID3D11DeviceContext *pD3D11DeviceContext, const XMFLOAT4X4 &Model,
	const XMFLOAT4X4 &View, const XMFLOAT4X4 &Proj)
{
	...
	BathShader.use(pD3D11DeviceContext);
...
bool Bath::init_shader(ID3D11Device *pD3D11Device, HWND hWnd)
{
	HRESULT result;
	...
	BathShader.init(pD3D11Device, vInputLayoutDesc);
	BathShader.attachVS(L"light.vsh", "VS", "vs_5_0");
	BathShader.attachPS(L"light.psh", "PS", "ps_5_0");
	BathShader.end();

	return true;
}

void Bath::init_texture(ID3D11Device *pD3D11Device, LPCWSTR texFile)
{
	HRESULT hr;
