...
void Glass::Render(ID3D11DeviceContext *pD3D11DeviceContext, ID3D11ShaderResourceView *pTexture, const XMFLOAT4X4 &Model,  
...
bool Glass::init_buffer(ID3D11Device *pD3D11Device, ID3D11DeviceContext *pD3D11DeviceContext)
{
	HRESULT hr;
...
bool Glass::init_shader(ID3D11Device *pD3D11Device, HWND hWnd)
{
	HRESULT result;
