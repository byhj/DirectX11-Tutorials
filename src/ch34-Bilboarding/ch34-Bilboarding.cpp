...
void D3DRenderSystem::v_Render()
{
	...
	world *= trans;
	XMStoreFloat4x4(&m_Model, XMMatrixTranspose(world) );

	square.Render(m_pD3D11DeviceContext, m_Model, m_View, m_Proj);
	DrawMessage();
...
void D3DRenderSystem::init_object()
{
	...
	square.init_buffer(m_pD3D11Device, m_pD3D11DeviceContext);
	square.init_shader(m_pD3D11Device, GetHwnd());
