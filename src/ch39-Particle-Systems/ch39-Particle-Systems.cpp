...
void D3DRenderSystem::v_Render()
{
	...
	particle.Frame(timer.GetDeltaTime());
	particle.Render(m_pD3D11DeviceContext, Model, View, Proj);
...
void D3DRenderSystem::init_object()
{
	...
	particle.init_buffer(m_pD3D11Device, m_pD3D11DeviceContext);
	particle.init_shader(m_pD3D11Device, GetHwnd());
	particle.init_texture(m_pD3D11Device, L"../../media/textures/star.dds");
