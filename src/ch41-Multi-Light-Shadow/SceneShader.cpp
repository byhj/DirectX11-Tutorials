...
namespace byhj
{
		                    ...
		                    const XMFLOAT4 &LightPos1, const XMFLOAT4 &lightPos2 )
	{
		...
		cbMatrix.lightView1 = LightView1;
		cbMatrix.lightPorj1 = LightProj1;
		cbMatrix.lightView2 = LightView2;
		cbMatrix.lightProj2 = LightProj2;
		pD3D11DeviceContext->UpdateSubresource(m_pMVPBuffer.Get(), 0, NULL, &cbMatrix, 0, 0);
		pD3D11DeviceContext->VSSetConstantBuffers(0, 1, m_pMVPBuffer.GetAddressOf() );

		LightBufferType2 lightbuffer;
		lightbuffer.lightPos1 = LightPos1;
		lightbuffer.lightPos2 = lightPos2;

		pD3D11DeviceContext->UpdateSubresource(m_pLightBuffer2.Get(), 0, NULL, &lightbuffer, 0, 0);
