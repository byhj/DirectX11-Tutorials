...
bool Plane::init_buffer(ID3D11Device *pD3D11Device, ID3D11DeviceContext *pD3D11DeviceContext)
{
	...
	hr = CreateDDSTextureFromFile(pD3D11Device, L"../../media/textures/metal001.dds", NULL, &m_pTextures[0]);
	//DebugHR(hr);
	hr = CreateDDSTextureFromFile(pD3D11Device, L"../../media/textures/grate.dds", NULL,  &m_pTextures[1]);
	//DebugHR(hr);
