...
{
	HRESULT hr;
	load_model("../../media/objects/sphere.txt");
	...
	dataPtr2->ambientColor   = XMFLOAT4(0.25f, 0.25f, 0.25f, 0.15f);
...
void Cube::init_texture(ID3D11Device *pD3D11Device)
{
	...
	HRESULT hr;
	hr = CreateDDSTextureFromFile(pD3D11Device, L"../../media/textures/ice.dds", NULL, &m_pTexture);
	//DebugHR(hr);
